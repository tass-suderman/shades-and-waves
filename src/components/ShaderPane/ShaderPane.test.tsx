...
// Mock hooks used by ShaderControls (rendered inside ShaderPane)
...
beforeEach(() => {
  ...
  mockUseAppStorage.mockReturnValue({
    muted: false, setMuted: vi.fn(),
    volume: 50, setVolume: vi.fn(),
    immersiveOpacity: 50, setImmersiveOpacity: vi.fn(),
  })
